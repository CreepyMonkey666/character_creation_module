...
def attack(char_name: str, char_class: str) -> str:
    """Функция генерирующая показатель урона персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция генерирующая показатель заблокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция вывода сообщений о применении специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция описывающая логику тренировки персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора персонажа и приветствия игрока."""
